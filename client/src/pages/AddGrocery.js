            ...
            <Box display="flex" flexDirection="row">
                ...
                <Container className={classes.rightSideBody} maxWidth="lg">
                    <Grid item xs={12}>
                        ...
                        <ul>
                            {
                                [1,2,3,4,5].map(item => <li>Hi</li>)
                            }
                        </ul>
                    </Grid>
                    <Box>
                        <Button variant="" className={classes.btn2}>Submit List</Button>
                    </Box>
                </Container>
            </Box>
        </Container>
...
const IMG_CATEGORY_PRODUCE = "https://i.pinimg.com/originals/fb/71/58/fb7158daf1b7dc968ef08f22713aa614.jpg"
...
function CategoryBox() {
    ...
    return(
        <Box className={classes.mainBox}>
            <Box alignItems="center" textAlign="center" color="white" fontWeight="700">
