...
function AddTripPage() {
    ...
    const handleTripConfirm = () => {
        const tripPayload = {
            storeName, storeLocation, storeDate, storeTime
        }
    ...
    return (
        <Container maxWidth="lg">
            ...
            <Box p={5} className={classes.mainBox} display="flex" flexDirection="column" borderRadius="7%" textAlign="center">
                ...
                <Box className={classes.inputGroup} display="flex" flexDirection="column" maxWidth={500}>
                    ...
                    <Button 
                        ...
                        className={classes.btn2}>Confirm</Button>
                </Box>
            </Box>
            }
        </Container>
...
function SimilarRequests({storeTime, storeName, storeLocation, storeDate}) {
    ...
    <Box className={classes.body}>
        <Box>
            ...
            <span className="header-sub"><b>{storeName}</b></span>
            <span className="header-sub"><b>at {storeTime}</b></span>
